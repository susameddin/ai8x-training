...
class AI85FaceIDNetV3(nn.Module):
    """
    ...
    def __init__(
        ...
        self.conv1 = ai8x.FusedConv2dBNReLU(num_channels, 32, 3, padding=1,
                                          bias=bias, **kwargs)
        self.conv2 = ai8x.FusedMaxPoolConv2dBNReLU(32, 64, 3, pool_size=2, pool_stride=2,
                                                 padding=1, bias=bias, **kwargs)
        self.conv3 = ai8x.FusedMaxPoolConv2dBNReLU(64, 64, 3, pool_size=2, pool_stride=2,
                                                 padding=1, bias=bias, **kwargs)
        ...
        self.conv8 = ai8x.FusedConv2dBNReLU(64, 128, 3, padding=1, bias=bias, **kwargs)
...
def ai85faceidnetv3(pretrained=False, **kwargs):
    """
    Constructs a FaceIDNet model.
    """
    assert not pretrained
    return AI85FaceIDNetV3(**kwargs)


models = [
    {
        'name': 'ai85faceidnetv3',
        'min_input': 1,
        'dim': 3,
    },
]
