...
class AI85FaceIDNetV2(nn.Module):
    """
    ...
    def __init__(
        ...
        self.conv7 = ai8x.FusedConv2dReLU(64, 128, 3, padding=1, bias=bias, **kwargs)
        self.conv8 = ai8x.FusedConv2dReLU(128, 128, 3, padding=1, bias=bias, **kwargs)
        self.conv9 = ai8x.FusedMaxPoolConv2d(128, 512, 1, pool_size=2, pool_stride=2,
...
def ai85faceidnetv2(pretrained=False, **kwargs):
    """
    Constructs a FaceIDNet model.
    """
    assert not pretrained
    return AI85FaceIDNetV2(**kwargs)


models = [
    {
        'name': 'ai85faceidnetv2',
        'min_input': 1,
        'dim': 3,
    },
]
